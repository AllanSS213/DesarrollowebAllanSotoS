...
public class ProjectConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        // Placeholder mappings for Practica 2 structure
        ...
        registry.addViewController("/consultas/listado").setViewName("consultas/listado");
        ...
        registry.addViewController("/usuario_rol/mantenimiento").setViewName("usuario_rol/mantenimiento");
